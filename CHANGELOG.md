...
**Current release: [Mercury 1.7.57](#1757---2026-05-11)** — released 2026-05-11; production-validated by **two paired measurements on the same substrate**: cycle 10 Phase 3 r4 at 21.3 B **full** Wikidata in 23 h 57 m end-to-end (2026-05-13), and truthy r1 at 8.17 B **truthy** Wikidata in 14 h 13 m end-to-end (2026-05-14). The truthy run is the apples-to-apples companion for external comparison vs published QLever / Virtuoso / WDBench numbers. Run `mercury --version` to confirm.

## What's Next

**Sky Omega 1.7.x** — cycle 10 Phase 3 r4 (full) + truthy r1 production validations **complete** as of 2026-05-14. Two paired 21.3 B + 8.17 B measurements on the same 1.7.57 substrate generation. The full-Wikidata measurement is the substrate-capability claim; the truthy-subset measurement is the apples-to-apples companion vs published WDBench / QLever / Virtuoso numbers (which run truthy). Trigram-phase finding: entries ratio truthy/full = 90.7 % at triple-count ratio 38.3 % = ~2.4× more literal-density per triple in truthy → trigram-phase prediction needs literal-volume scaling, not triple-count scaling (dump-date confounder noted: truthy 2026-05-08, full 2026-04-03). See [truthy r1 validation](docs/validations/truthy-r1-2026-05-14.md).
