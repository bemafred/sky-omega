...
| [ADR-012](ADR-012-debug-state-surfaces.md)                       | Debug-State Surfaces — a Surface-Agnostic Model and its First Human Views (TUI Dashboard, Avalonia Sibling) | Proposed · Phases 1–2 built (2026-06-26) |
