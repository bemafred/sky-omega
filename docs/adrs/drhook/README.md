...
| [ADR-007](ADR-007-teardown-concurrency-test-debug.md)            | Teardown and Concurrency Hardening; Substrate-Aligned Test-Runner Debugging; Integration-Test Mechanism Characterization | Proposed |
