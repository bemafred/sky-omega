...
| [ADR-051](ADR-051-trigram-index-over-iris.md) | Trigram Index over IRIs — Fast Fuzzy Recall over IRI Names (extend the object-literal-only scope; Lucy's associative-recall primitive) | Proposed (2026-06-23) |
