...
**Status:**        Resolved (1.7.46, commit `527016f`, 2026-04-29)
...
**Resolved:**      1.7.46 cancellation-token coverage shipped 2026-04-29 (commit `527016f`). Every property-path inner loop and B+Tree leaf walk now samples `QueryCancellation.ThrowIfCancellationRequested()` per `MoveNext()`. Production-validated WDBench 1.7.47 cold baseline 2026-04-29 (all 655 timeouts closed between 60.000 s and 63.620 s). Re-validated cycle 9 (2026-05-09 paths+c2rpqs 588/1199), cycle 10 r4 (2026-05-13 paths+c2rpqs 616/1199), truthy r1 + extended coverage (2026-05-14/15/16 paths+c2rpqs+single+multi+opts full matrix), WGPB step C (2026-05-16, 849/850). 0 cancellation contract violations across 8,564 unique query × substrate executions cumulatively across 1.7.46 → 1.7.57.
