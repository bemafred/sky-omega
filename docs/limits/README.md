...
| [Single-threaded spill blocks parser](spill-blocks-parser.md) | **Triggered** (cycle 8 measured: ~38% of parser wall-clock blocked on sort) | Trigger met. 21.3B parser ran 14h15m wall-clock with 5h+ blocked on sort across 3,923 spills. Sort:write 12-16:1 cross-scale (10M/100M/1B/21.3B). Mitigation: pipelined spill (double-buffer) — Round 2 candidate, evidence-justified. |
