...
See **[DRHOOK.md](DRHOOK.md)** for the DrHook debugging workflow (observe-before-fixing), the 22-tool MCP reference, how to run each test kind, and the probe corpus — the runtime-observation counterpart to [MERCURY.md](MERCURY.md).
