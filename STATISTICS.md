...
| SPARQL 1.1 Query | 144 | 224 | **64%** | 9 skipped, 71 failing; Negation 12/12 ✓, EXISTS 6/6 ✓, PP30 ✓ (see [ADR-012](docs/adrs/mercury/ADR-012-conformance-fix-plan.md)) |
| SPARQL 1.1 Update | 94 | 94 | **100%** | Full conformance |
| **Total** | **1,817** | **1,904** | **95%** | SPARQL Query conformance in progress |
