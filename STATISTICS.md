...
| SPARQL 1.1 Query | 183 | 224 | **82%** | 7 skipped, 34 failing; TZ/TIMEZONE/comparison ops added (see [ADR-012](docs/adrs/mercury/ADR-012-conformance-fix-plan.md)) |
| SPARQL 1.1 Update | 94 | 94 | **100%** | Full conformance |
| **Total** | **1,856** | **1,904** | **97%** | SPARQL Query conformance in progress |
